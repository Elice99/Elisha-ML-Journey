...
# wallet-test is the name of your image
docker build -t wallet-test .


Step 3: Run the API Service
Run the container, mapping the internal port 9696 to a port on your host machine (e.g., 9696).

docker run -it --rm -p 8080:9696 wallet-test

The prediction service will now be running at http://localhost:9696.
...
If your service is running on port 9696:
{
  "tx_count_365d": 300.0,
  "vol_per_tx": 3333.33,
